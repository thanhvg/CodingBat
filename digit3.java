...
// 4. Note that mod (%) by 10 yields the rightmost digit (126 % 10 is
// 6), while divide (/) by 10 removes the rightmost digit (126 / 10 is
// 12).
...
public int count8(int n) {
  ...
  if (n % 100 == 88 )  return count8(n/10) + count8(n%10) + 1;
